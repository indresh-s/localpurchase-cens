...
def add(request):
    if request.method == 'POST':
        ...
        recipient_list = [settings.EMAIL_ADMIN_ID, settings.EMAIL_DEVELOPER_ID],
...
#        print(">>>>>>"+id+"<<<<<<<<")
 #       print("-----dic----")
  #      print(itm_with_qty)
        ...
        from_email = settings.EMAIL_HOST_USER,
        recipient_list = [settings.EMAIL_ADMIN_ID,settings.EMAIL_DEVELOPER_ID,settings.EMAIL_BILL_SUBMITER,user_email,requester_email],
